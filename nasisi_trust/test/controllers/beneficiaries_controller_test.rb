...
class BeneficiariesControllerTest < ActionController::TestCase
  ...
  test "should create beneficiary" do
    assert_difference('Beneficiary.count') do
      post :create, beneficiary: { age: @beneficiary.age, area: @beneficiary.area, bio_data: @beneficiary.bio_data, gender: @beneficiary.gender, integer: @beneficiary.integer, names: @beneficiary.names, school: @beneficiary.school, string: @beneficiary.string, string: @beneficiary.string, string: @beneficiary.string, string: @beneficiary.string, string: @beneficiary.string }
    end
  ...
  test "should update beneficiary" do
    patch :update, id: @beneficiary, beneficiary: { age: @beneficiary.age, area: @beneficiary.area, bio_data: @beneficiary.bio_data, gender: @beneficiary.gender, integer: @beneficiary.integer, names: @beneficiary.names, school: @beneficiary.school, string: @beneficiary.string, string: @beneficiary.string, string: @beneficiary.string, string: @beneficiary.string, string: @beneficiary.string }
    assert_redirected_to beneficiary_path(assigns(:beneficiary))
  end
